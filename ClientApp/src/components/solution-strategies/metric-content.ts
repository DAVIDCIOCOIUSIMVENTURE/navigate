...
export const IMPACT_CONTENT: MetricContent = {
  ...
  caseStudies: [
    ...
    },
    {
      ...
      outcome: "Became a billions-in-GMV programme without ever being the product's headline feature. A score of 3 is a very healthy place to be if feasibility is also strong.",
    },
    {
      icon: Coffee,
      iconBg: "bg-emerald-800",
...
export const COST_CONTENT: MetricContent = {
  ...
  caseStudies: [
    ...
    },
    {
      ...
      score: 5,
      reasoning: "Required new factories, new supplier relationships, new certification processes, and multi-billion-pound tooling. Cost was visible from day one to anyone who could read an industrial roadmap.",
