...
export default function ProblemTriggerBucketsPage() {
  const navItem = getNavigationItem("/problem-trigger-buckets")
    ...
    <div className="flex flex-col h-full w-full gap-6 flex-1">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold">Problem Trigger Buckets</h1>
        </div>
        <p className="text-muted-foreground">
          Combine different problem triggers to generate new business concepts. You can use the same problem trigger in multiple buckets to explore different possibilities.
          We recommend you select triggers from different categories.
        </p>
      </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col">
              <DialogHeader>
                ...
                <DialogDescription>
                  {editingContainer ? 'Edit your problem triggers buckets and its problem triggers.' : 'Create a new container and select problem triggers to add to it.'}
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter className="mt-4">
                {editingContainer && (
                  <Button
                    ...
                    className="mr-auto"
                    onClick={() => {
                      setContainerToDelete(editingContainer)
                      setIsDialogOpen(false)
                    }}
                  >
                    Delete
