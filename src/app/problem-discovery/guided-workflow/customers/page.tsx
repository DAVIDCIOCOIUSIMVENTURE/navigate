...
import { useWorkflow, getAdjacentSteps, type CustomerFields } from "../context"
...
const FIELDS: {
  ...
  { key: "ageRange", label: "Age Range", placeholder: "e.g. 25–40" },
  {
    key: "whoTheyAre",
    label: "Who They Are",
    placeholder: "Describe their background, lifestyle, and identity...",
    multiline: true,
  },
  {
    key: "whatTheyDo",
    label: "What They Do",
    placeholder: "Describe their daily activities and responsibilities...",
    multiline: true,
  },
  {
    key: "goalsAndMotivations",
    label: "Goals & Motivations",
    placeholder: "What are they trying to achieve? What drives them?",
    multiline: true,
  },
  {
    key: "frustrationsAndChallenges",
    label: "Frustrations & Challenges",
    placeholder: "What blocks them from achieving their goals?",
    multiline: true,
  },
]
...
export default function CustomersPage() {
  ...
  const { customer, setCustomer } = useWorkflow()
