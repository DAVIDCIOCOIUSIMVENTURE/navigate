...
export const IMPROVE_CASE_STUDIES: ImproveCaseStudy[] = [
  {
    ...
    outcome: "Amazon turned shipping from a cost center into a competitive moat. Prime became the gold standard for ecommerce convenience, with over 200 million members worldwide willing to pay annually for the improved experience.",
  },
  {
  ...
  },
  {
    ...
    improvements: [
      ...
      { group: "Value & Trust", dimension: "Price Value", idea: "Launch the Starbucks Rewards loyalty program with free drinks, birthday rewards, and early access to new items." },
