...
export default function ExploreReviewPage() {
  ...
  const { projectId, problem, customerDescription, existingSolutions, jobsToBeDone } = useProblem()
  ...
  const goTo = (step: ExploreStepPath) => router.push(projectRoutes.explore(projectId, step))
