...
export default function RefinePage() {
  ...
  const { projectId, analysisToolType } = useProblem()
  ...
  useEffect(() => {
    if (!SHOW_REFINEMENT_STEPS) router.replace(projectRoutes.explore(projectId, "customer"))
  }, [router, projectId])
      ...
      <CardContent className="p-10 pt-6 flex flex-col gap-6">
        ...
        {!analysisToolType && (
          <div className="flex flex-col items-center justify-center gap-3 py-8 rounded-lg border border-dashed">
            ...
            <Button variant="outline" onClick={() => router.push(projectRoutes.explore(projectId, "choose-refinement"))}>
