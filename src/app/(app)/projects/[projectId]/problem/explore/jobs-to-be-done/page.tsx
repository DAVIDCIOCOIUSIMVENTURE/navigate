    ...
    <Card className="w-full flex-1">
      ...
      <CardContent className="p-10 pt-6 flex flex-col gap-6">
        <div className="flex flex-col gap-3 text-base">
          ...
          <p>
            Add at least one goal under each of the three headings. Lean into emotional and social goals even if they feel softer than the tangible tasks: those are usually where the price comes from. Later, when you test the problem, you will choose one of these goals as the anchor for the price, then put a number on what a customer would pay to make the problem go away. Pick whichever goal truly drives the decision to buy, whatever its type.
          </p>
        </div>
        ...
        <StrategyTabs strategy={<JobsToBeDoneStrategy />}>
