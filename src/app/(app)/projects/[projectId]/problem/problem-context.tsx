 ...
 *
 * This provider is shared by the project's problem edit page, the "Explore
 * the Problem" flow (projects/[projectId]/problem/explore) and the "Problem
 * Validation" flow (projects/[projectId]/problem/validation). Each of those
 * folders re-exports ProblemProvider / useProblem from here and adds its own
 * step list (NAV_ITEMS) and getAdjacentSteps helper. The project id is what
 * routes are built from; the problem id comes from the project.
 *
 * Mirror: src/app/(app)/projects/[projectId]/solutions/[solutionId]/validate/context.tsx.
 */
...
type ProblemContextValue = {
  /** The project the problem belongs to; every route under the problem is built from it. */
  projectId: number
  problemRef: string
  problemId: number
