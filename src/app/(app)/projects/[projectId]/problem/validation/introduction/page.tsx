...
const STEPS = [
  { icon: PoundSterling, title: "What they would pay to solve it", description: "Anchored on one of the goals you captured while exploring the problem, estimate the price a single customer would happily pay each time the problem occurs." },
...
export default function IntroductionPage() {
  ...
  const { nextPath } = getAdjacentSteps(pathname, projectId)
