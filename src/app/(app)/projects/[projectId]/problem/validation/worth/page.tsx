  ...
  return (
    <Card className="w-full flex-1">
      <CardHeader className="px-10 pt-10 pb-0">
        <CardTitle icon={PoundSterling}>What they would pay to solve it</CardTitle>
      </CardHeader>
      <CardContent className="p-10 pt-6 flex flex-col gap-6">
        <div className="flex flex-col gap-3 text-base">
          <p>
            Now that you know what the customer is trying to achieve, you can put a number on what one customer would happily pay to make the problem go away. The next step multiplies this figure across a whole population, so being a few times off here compounds into a wildly misleading market size. Honesty beats ambition.
          </p>
          <p>
            The trick is to anchor the price on one goal from your list, not on the cost of building a feature. People will pay disproportionately to stop a feeling, far more than they will pay for a tidy version of the tangible task. A house move with no chain anxiety is the same task functionally as one with a fragile chain, but the price someone will pay to make the chain anxiety disappear is a different number altogether.
          </p>
          <p>
            Why one goal and one price? A customer buys a solution for a single primary goal: the one that tips them into buying. The other goals still matter, but they nudge what someone will pay rather than each stacking on as a separate charge. So you capture one price, anchored on that one dominant goal, and you pick which goal that is on this step. It is often an emotional or social pull, but a functional goal can be the anchor when it is what truly drives the purchase.
          </p>

          <h3 className="mt-4 text-xl font-bold text-foreground">How to read a price off what the customer is trying to achieve</h3>
          <div className={cn("grid gap-3", containerSize === "narrow" ? "grid-cols-1" : "grid-cols-3")}>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground">Anchor on the one goal that drives the purchase</p>
                <p className="text-base">Pick the single goal that tips the customer into buying. It is usually the highest-intensity emotional or social pull, since people pay disproportionately to stop a feeling, but a functional goal can be the anchor when that is what really drives the decision. The price is anchored on that one goal, not on what it costs you to deliver.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
          ...
          <p className="mt-2 text-base">
            A useful sense check: let your anchor goal set the ceiling and real spend set the floor, then land between them and lean toward the lower end. Aggressive estimates feel motivating in private and embarrassing in front of investors, so err toward the conservative read.
          </p>

          <h3 className="mt-4 text-xl font-bold text-foreground">What will you do?</h3>
          <p>
            Pick the one goal that drives the purchase, then enter the price a single customer would happily pay each time the problem occurs, in the currency that matches them. This figure carries forward to the next step where you multiply it by the population to produce the total market figure, so capture it with the same level of honesty you would use in front of a sceptical investor.
          </p>
        </div>
        ...
        <StrategyTabs strategy={<WorthStrategy />}>
            <div className={`${CASE_STUDY_PANEL_CLASS} gap-5`}>
              <p className="text-base text-foreground">
                See how successful companies anchored a price on the one goal that drives the purchase, not on the cost of building the feature.
              </p>
