    ...
    <Card className="w-full flex-1">
      ...
      <CardContent className="p-10 pt-6 flex flex-col gap-6">
        ...
        <ReviewSection>
          ...
          {candidates.length === 0 ? (
            <EmptyHint text="No candidates saved for this problem yet. Go back to the Discover step to add some." />
          ) : (
            <>
              <p className="text-base text-white">
                {candidates.length} {candidates.length === 1 ? "candidate" : "candidates"} in your solutions for this problem. The badge shows which method produced each one.
              </p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mt-2">
          ...
          <Button onClick={() => router.push(finishHref)} className="gap-2">
