 ...
 *
 * Mirror: src/app/(app)/projects/[projectId]/problem/validation/context.tsx.
 */
...
type SolutionContextValue = {
  /** The project the solution belongs to; every route under the solution is built from it. */
  projectId: number
  solutionId: number
...
export function getAdjacentSteps(pathname: string, projectId: number, solutionId: number) {
  const base = projectRoutes.solutionValidateBase(projectId, solutionId)
