...
export default function ValidationReviewPage() {
  ...
  const { projectId, solutionId, solution } = useSolution()
  const { prevPath } = getAdjacentSteps(pathname, projectId, solutionId)
      ...
      <CardContent className="p-10 pt-6 flex flex-col gap-6">
        ...
        <div className="flex justify-between mt-2">
          ...
          <Button
            ...
            onClick={() => router.push(projectRoutes.solutionEdit(projectId, solutionId))}
          >
