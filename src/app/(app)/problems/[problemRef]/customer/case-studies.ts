...
export const CUSTOMER_CASE_STUDIES: CustomerCaseStudy[] = [
  {
    ...
    segmentSize: "~30 million small businesses in the US alone",
    whyThisWorks:
  ...
  },
  {
    ...
    customerDescription:
      "Individual knowledge workers and small startup teams (2–15 people) who juggle notes, wikis, project boards, and documents across multiple disconnected tools like Google Docs, Trello, and Evernote. They are tech-savvy, value flexibility, and are willing to invest time customising a tool if it can replace several others.",
    segmentSize: "~50 million knowledge workers globally who use 3+ productivity tools",
    whyThisWorks:
