...
const STEPS = [
  ...
  { icon: Sparkles, title: "Jobs your customer is trying to get done", description: "List the tangible tasks they need to complete, how they want to feel, and how they want to be seen. On the next step you pick one of these jobs to anchor the price." },
  { icon: DollarSign, title: "What they would pay to solve it", description: "Anchored on one job you pick from the previous step, estimate the price a single customer would happily pay each time the problem occurs." },
