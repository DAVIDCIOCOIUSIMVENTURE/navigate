...
const STEPS = [
  ...
  { icon: DollarSign, title: "What they would pay to solve it", description: "Anchored on the strongest job from the previous step, estimate the price a single customer would happily pay each time the problem occurs." },
