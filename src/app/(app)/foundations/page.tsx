          ...
          <div className="flex flex-col gap-6 @[800px]:flex-row @[800px]:items-center">
            <div className="flex flex-col gap-6 flex-1 min-w-0">
              ...
              <p className="text-base text-foreground leading-relaxed">
                ...
                Why finding the right idea matters. What goes wrong when people skip testing their idea. What went well for founders who did the work. We don&apos;t cover <span className="italic">how</span> to solve things here: that&apos;s what your projects are for.
              </p>
            </div>
            ...
            {FOUNDATIONS_SECTIONS.map((section) => {
              ...
              return (
                <button
                  ...
                  className="text-left flex items-start gap-3 p-4 rounded-lg bg-secondary-brand text-white hover:bg-secondary-brand/90 transition-colors"
                >
