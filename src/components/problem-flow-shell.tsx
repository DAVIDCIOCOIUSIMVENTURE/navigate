 ...
 * `FlowShell` plus the problem reminder (context card plus a View Problem
 * button that opens the problem hub dialog) under the step list.
 */
  ...
  return (
    <>
      <FlowShell
        ...
        journeyProblemId={Number(problemRef)}
        context={
          <>
