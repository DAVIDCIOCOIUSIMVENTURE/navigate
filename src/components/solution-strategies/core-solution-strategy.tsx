  ...
  if (readOnly && !solution.title.trim() && !solution.description.trim()) {
    return (
      <div className="bg-secondary-brand rounded-xl p-8">
        <p className="text-base text-white/70 italic">No solution details captured.</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-secondary-brand rounded-xl p-8 flex flex-col gap-5">
      <div className="flex flex-col gap-2">
        <label htmlFor="core-solution-title" className="text-base font-medium text-white">
          Title
        </label>
        <Input
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="core-solution-description" className="text-base font-medium text-white">
          Description
        </label>
        <Textarea
