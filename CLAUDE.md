...
* `worth`: a single price the customer would happily pay each time the problem occurs, anchored on the strongest job. Captured as `validationAssessment.worthToThem`.
